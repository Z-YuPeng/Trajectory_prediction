...
if __name__ == "__main__":
    ...
    parser.add_argument("-c", "--train_dataset", default=None, type=str, help="train dataset for train bert")
    parser.add_argument("-t", "--test_dataset", type=str, default=None, help="test set for evaluate train set")
    parser.add_argument("-v", "--vocab_path", default=None, type=str, help="built vocab model path with bert-vocab")
    parser.add_argument("-o", "--output_path", default='./output/model', type=str, help="ex)output/bert.model")
    ...
    train_dataset = BERTDataset('./dataset/corpus.csv', vocab, seq_len=args.seq_len,
